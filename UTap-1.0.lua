...
local EspSec = CreateSection(VisualsPage, "ESP Features")
...
if drawing and drawing.new then
    ...
    FOVCircle.Color = Color3.fromRGB(224, 159, 62)
    ...
    setmetatable(FOVCircle, {
        __newindex = function(t, k, v)
            ...
            elseif k == "Radius" then
                t._frame.Size = UDim2.new(0, v * 2, 0, v * 2)
...
local function UpdateESP()
    ...
    for _, player in pairs(Players:GetPlayers()) do
        if player ~= LocalPlayer and player.Character and player.Character:FindFirstChild("HumanoidRootPart") and player.Character:FindFirstChildOfClass("Humanoid") and player.Character.Humanoid.Health > 0 then
            ...
            if Config.ESP_Names or Config.ESP_Box or Config.ESP_Item then
